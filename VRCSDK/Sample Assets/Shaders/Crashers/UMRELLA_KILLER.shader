Shader "UnityFags SDK/Crashers/UMBRELLA KILLER"
//starina umbrella fix
//Bastik help 
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			//WhyYOUKILLEDME
			//Ќе судите строго первый краш который сделал на подобие одного) улучшил и сделал его сильнее
