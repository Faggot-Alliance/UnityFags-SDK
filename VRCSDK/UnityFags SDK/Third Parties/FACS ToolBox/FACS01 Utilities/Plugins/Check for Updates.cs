...
namespace FACS01.Utilities
{
    ...
    public class CheckForUpdates
    {
        ...
        [MenuItem("UnityFags SDK/FACS Utils/Check for Updates", false, 999)]
        ...
        {
            string myVersion = File.ReadLines(Application.dataPath + "UnityFags SDK/Third Parties/FACS ToolBox/FACS01 Utilities/version.txt").First();
