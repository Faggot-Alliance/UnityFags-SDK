...
public partial class VRCSdkControlPanel : EditorWindow
{
    ...
    [MenuItem("UnityFags SDK/Show Control Panel", false, 600)]
    static void ShowControlPanel()
    {
        ...
        window.titleContent.text = "UnityFags SDK";
    ...
    private readonly GUIContent[] _toolbarLabels = new GUIContent[5]
    {
        new GUIContent("Authentication"),
        new GUIContent("Builder"),
        new GUIContent("Content Manager"),
        new GUIContent("Settings"),
        new GUIContent("Discord RPC"),
    };

    private readonly bool[] _toolbarOptionsLoggedIn = new bool[5] {true, true, true, true,true};
    private readonly bool[] _toolbarOptionsNotLoggedIn = new bool[5] {true, false, false, false,true};
