...
public partial class VRCSdkControlPanel : EditorWindow
{
    ...
    static string betaKey { get; set; } = null;
    ...
    static bool OnAccountGUI()
    {
        ...
        GUILayout.BeginVertical("Account", "window", GUILayout.Height(150), GUILayout.Width(417));
        ...
        else if (APIUser.IsLoggedIn)
        {
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Label("");
            var styletext = new GUIStyle(GUI.skin.button);
            styletext.normal.textColor = Color.red;
            GUI.backgroundColor = Color.black;
            if (GUILayout.Button("★ Logout ★", styletext, GUILayout.Width(417)))
            {
        ...
        {
            var styletext = new GUIStyle(GUI.skin.button);
            styletext.normal.textColor = Color.grey; 
            InitAccount();
            ...
            betaKey = EditorGUILayout.PasswordField("Key", betaKey);
            GUI.backgroundColor = Color.black;
            if (GUILayout.Button("★ Sign In ★", styletext))
                SignIn(true);
            if (GUILayout.Button("★ Sign up ★", styletext))
    ...
    {
        EditorGUILayout.LabelField("Username:", APIUser.CurrentUser.username);
        EditorGUILayout.LabelField("Logged in as:", APIUser.CurrentUser.displayName);
        EditorGUILayout.LabelField("Current Avatar ID:", APIUser.CurrentUser.avatarId);
