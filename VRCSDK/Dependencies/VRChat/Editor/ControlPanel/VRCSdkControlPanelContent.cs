...
public partial class VRCSdkControlPanel : EditorWindow
{
    ...
    const int RIP_WORLD_BUTTON_WIDTH = 75;
    ...
    const int AVATAR_EZRIP_BUTTON_WIDTH = 100;
            ...
            if (uploadedWorlds.Count > 0)
            {
                ...
                if (WorldsToggle)
                {
                    ...
                    foreach (ApiWorld w in tmpWorlds)
                    {
                        ...
                        if (GUILayout.Button("Rip World", GUILayout.Width(RIP_WORLD_BUTTON_WIDTH)))
                        {
                            if (EditorUtility.DisplayDialog("W.I.P","THIS IS NOT OUT YET","OK"));
                        }
                        if (expandedLayout)
                            EditorGUILayout.EndHorizontal();
                        else
            ...
            if (uploadedAvatars.Count > 0)
            {
                ...
                if (AvatarsToggle)
                {
                    ...
                    foreach (ApiAvatar a in tmpAvatars)
                    {
                        ...
                        if (GUILayout.Button("Rip Avatar", GUILayout.Width(DELETE_AVATAR_BUTTON_WIDTH)))
                        {
                            Application.OpenURL(a.assetUrl);
                        }
