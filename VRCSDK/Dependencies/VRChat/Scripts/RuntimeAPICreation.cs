...
namespace VRCSDK2
{
    ...
    public class RuntimeAPICreation : MonoBehaviour
    {
        ...
        protected string CustomImagePath;
        ...
        protected void Start()
        {
            ...
            ImageWidth = imageCapture.resWidth;
            ImageHeight = imageCapture.resHeight;
        ...
        protected IEnumerator UpdateImage(string existingFileUrl, string friendlyFileName)
        {
            ...
            {
                Debug.Log("Uploading photo from VRCCam.");
                imagePath = imageCapture.TakePicture();
            }
            else
            {
                Debug.Log("Uploading photo from Custom File!");
